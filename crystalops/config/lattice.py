...
def FCC_111():
    axis = [[1.22474487, 0, 0], [0, 1.73205081, 0], [0, 0, 0.70710678]]
    return Lattice('FCC_111', [[0, 0, 0], [0.66666667, 0.66666667, 0], [0.33333333, 0.33333333, 0], [0.5, 0, 0.5], [0.83333333, 0.33333333, 0.5], [0.16666667, 0.66666667, 0.5]], axis)

def FCC_X_1():
    axis = [[1.73205081, 0, 0], [0, 1.22474487, 0], [0, 0, 0.70710678]]
    return Lattice('FCC_X_1', 
                   [[0.33333333, 0.66666667, 0], [0, 0, 0],
                    [0.66666667, 0.33333333, 0.00000000], [0.66666667, 0.83333333, 0.50000000],
                    [0.33333333, 0.16666667, 0.50000000], [0.00000000, 0.50000000, 0.50000000]], axis)
    
def FCC_X_2():
    axis = [[1.73205081, 0, 0], [0, 1.22474487, 0], [0, 0, 0.70710678]]
    return Lattice('FCC_X_2', 
                   [[0.00000000, 0.00000000, 0.00000000], [0.66666667, 0.66666667, 0.00000000],
                    [0.33333333, 0.33333333, 0.00000000], [0.66666667, 0.16666667, 0.50000000],
                    [0.33333333, 0.83333333, 0.50000000], [0.00000000, 0.50000000, 0.50000000]], axis)
...
def BCO(ratio_yx = 2, ratio_zx = 3):  # Body-Centered Orthorhombic
    ...
    return Lattice('BCO', [[0, 0, 0], [0.5, 0.5, 0.5]], axis)
