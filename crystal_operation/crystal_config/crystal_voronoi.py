...
# def plot_voronoi_polyhedron(vertices, faces,
#                             color='skyblue', edge_color='k', alpha=0.4, show_vertices=True):
#     """
#     Visualize a Voronoi polyhedron with better 3D effect.
...
#     ax = fig.add_subplot(111, projection='3d', proj_type='persp')  # perspective projection

#     # Build each face
#     poly3d = [[vertices[idx] for idx in face] for face in faces]

#     # Make face collection with shading
#     collection = Poly3DCollection(
#         poly3d,
#         facecolors=plt.cm.Blues(0.5),  # use a colormap for smooth effect
...
#     # Adjust view and remove clutter
