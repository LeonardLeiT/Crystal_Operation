...
# 1. Data preparation
data = {}
data[0] = np.loadtxt(f'Equli_300_0_RDF.txt')
data[1] = np.loadtxt(f'min_700_0_RDF.txt')
data[2] = np.loadtxt(f'amorphous-1_RDF.txt')
...
ax.set_xlim(0, 15)
ax.set_ylim(0.001, 4.5)
ax.legend(frameon=False)

plt.savefig('rdf-all.svg', format='svg', dpi=300, bbox_inches='tight')
plt.savefig('rdf-all.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.tight_layout()
plt.show()