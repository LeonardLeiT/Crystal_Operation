...
combine_crystal = {}
# O
combine_crystal[0] = Lt.Move(Voronoi_crytsal_2[0], move_position.point[1], Range)
combine_crystal[1] = Lt.Move(Voronoi_crytsal_2[0], move_position.point[15], Range)
# A
# combine_crystal[2] = Lt.Move(Voronoi_crytsal[1], move_position.point[0], Range)
combine_crystal[3] = Lt.Move(Voronoi_crytsal_1[1], move_position.point[14], Range)
# B
combine_crystal[4] = Lt.Move(Voronoi_crytsal_1[2], move_position.point[8], Range)
...
combine_crystal[7] = Lt.Move(Voronoi_crytsal_1[3], move_position.point[4], Range)
# D
combine_crystal[8] = Lt.Move(Voronoi_crytsal_1[4], move_position.point[2], Range)
...
# 6. Output Cfg
Lt.Cfg(all, Lattice.axis, [Size*2, Size*2, Size*2], M, a, Cfg_name)